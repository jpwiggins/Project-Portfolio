...
app.use((req, res, next) => {
  const allowedOrigins = [
    "https://www.imaginabletechnologies.com",
    "https://imaginabletechnologies.com"
  ];
  ...
  res.header(
    ...
    "script-src 'self' 'unsafe-inline' https://js.stripe.com https://checkout.stripe.com https://*.stripe.com https://*.stripe.network; frame-src 'self' https://js.stripe.com https://hooks.stripe.com https://checkout.stripe.com; connect-src 'self' https://api.stripe.com https://*.stripe.com https://*.stripe.network; style-src 'self' 'unsafe-inline' https://checkout.stripe.com; img-src 'self' data: https:; font-src 'self' data:; object-src 'none'; base-uri 'self';"
  );
  next();
});
app.use((req, res, next) => {
