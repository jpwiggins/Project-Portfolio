...
// Enable CORS for development and CSP for Stripe
app.use((req: Request, res: Response, next: NextFunction) => {
  ...
  res.header('Content-Security-Policy', 
    "script-src 'self' 'unsafe-inline' https://js.stripe.com https://checkout.stripe.com https://*.stripe.com https://*.stripe.network; " +
